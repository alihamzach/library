# Generated by Django 4.2.1 on 2023-05-21 18:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rent_per_day', models.IntegerField(blank=True, null=True)),
                ('days', models.IntegerField(blank=True, null=True)),
                ('amount', models.IntegerField(blank=True, null=True)),
                ('request', models.BooleanField(default=False)),
                ('book_detail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.bookdetail')),
